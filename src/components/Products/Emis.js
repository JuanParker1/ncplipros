    ...
    <>
      ...
      <div style={{ display: "flex", justifyContent: "center"}}>
        <Root>
          ...
          <div>
            <div style={{ display: "flex", justifyContent: "center" }}>
              <Typography variant="h4" style={{ borderBottom: "4px solid green", }}>Features of EMIS</Typography>
            </div>
            <Divider></Divider>
            <br />
            <Typography variant='subtitle1' style={{ textAlign: "justify" }} gutterBottom><ArrowForwardIcon fontSize="small"  style={{verticalAlign:"middle",marginBottom:"5px"}}/>Instructors can create end to end customized and engaging courses by adding teaching materials  using their favourite medium. Principal can access teachers and students dashboard. Teachers can  record the week plan, time table and schedule. Students get notified about the updates. As a  school administrator, take attendance, record assessments, and oragnize staff data. EMIS school  facilities the collection, processing, and management of information at the school. It is a  customizable application that supports the day-to-day activities involved in managing an  individual school. EMIS Classroom is a mobile app for android that facilities the collection of  data at the class room level. Techers can collect data on attandance , assessments and behaviors. </Typography>
            <Typography variant='subtitle1' style={{ textAlign: "justify" }} gutterBottom><ArrowForwardIcon fontSize="small"  style={{verticalAlign:"middle",marginBottom:"5px"}}/>EMIS classroom data can then be exported and shared in standard output formats. EMIS  Classroom is able to function with an active in ternet connection. </Typography>
            <Typography variant='subtitle1' style={{ textAlign: "justify" }} gutterBottom><ArrowForwardIcon fontSize="small"  style={{verticalAlign:"middle",marginBottom:"5px"}}/>Principals and education officails can easily and quickly search, viw and update staff details  using a mobile device including staff photos.EMIS staffroom connects to securely access and  update information. </Typography>
            <Typography variant='subtitle1' style={{ textAlign: "justify" }} gutterBottom><ArrowForwardIcon fontSize="small"  style={{verticalAlign:"middle",marginBottom:"5px"}}/>EMIS provides the Digital Content that gives a central repository accessible to teachers across  Tamil Nadu and Unique login identifier for Teachers linked with state curiculum. Also track your  personal career excellence. With the help of this portal, the school administration also provides  all the information about the syllabus, school timings, new notices, and modification details in  online.</Typography>
